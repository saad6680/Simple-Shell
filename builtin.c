...
*Return:withagivenexitstatusreturnexit
*(0)ifinfo->argv[0]!="exit"
*/
...
*@info:thestructcontainingpotentialarguments.forprototype
*Return:Always0
*/
...
mod_eputs(info->argv[1]),mod_eputchar('\n');
}
else
{
...
/**
*mod_myhelp-changesthecurrentdirectoryoftheprocess
